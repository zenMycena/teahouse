...
public class DataConfiguration {
	 @Bean
	  public DataSource dataSource() throws SQLException {
		...
		dataSource.setUrl("jdbc:mysql://127.13.152.130:3306/teahouse?characterEncoding=UTF-8");
		dataSource.setUsername("adminIFCeiSh");
		dataSource.setPassword("Q9wD8H6FiW6d");
		return dataSource;
	  }
